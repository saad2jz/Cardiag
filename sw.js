...
const APP_SHELL = [
  ...
  './css/auth/auth.css?v=20260902-1',
  ...
  './js/onboarding/profile-onboarding.js?v=20260902-3',
  './js/auth/firebase-client.js?v=20260902-3',
...
self.addEventListener('fetch', (event) => {
  ...
  // Runtime authentication configuration and helper callbacks must never be
  // answered from Cache Storage. A stale authDomain breaks Google OAuth even
  // after a successful deployment and a hard browser refresh.
  if (url.pathname === '/firebase-config.json' || url.pathname.startsWith('/__/auth/')) return;
