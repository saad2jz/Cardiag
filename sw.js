...
const APP_SHELL = [
  ...
  './css/landing/landing.css?v=20260826-2',
  ...
  './js/app.js?v=20260826-20',
  './js/navigation/home-button.js?v=20260825-2',
  './js/navigation/router.js?v=20260826-6',
  './js/navigation/route-controller.js?v=20260826-8',
  './js/landing/landing.js?v=20260826-4',
  ...
  './js/onboarding/profile-onboarding.js?v=20260826-5',
  './js/auth/firebase-client.js?v=20260826-5',
  ...
  './js/settings/settings.js?v=20260826-3',
  './js/score/score-visuals.js?v=20260813-1',
  './js/records/records-gallery.js?v=20260826-1',
